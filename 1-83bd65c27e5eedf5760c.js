    ...
    219: function(n, t, e) {
      ...
      var i = e(7),
        ...
        y = r.c.li.withConfig({
          ...
          [
            'margin:0;&:not(:last-child){border-bottom:1px dotted rgba(0,16,64,0.1);}> a{display:block;padding:10px 25px;padding-left:calc(25px + 4%);font-size:18px;',
      ...
      var _ = r.c.header.withConfig({
        ...
        nn = Object(r.c)(l.d).withConfig({
          displayName: 'Header__ButtonLink',
          componentId: 'sc-9eu2yh-3',
        })([
          'background:rgba(255,255,255,0.15);padding:12px 24px;border-radius:4px;transition:all 0.25s;color:#ffffff;margin:0 10px 10px;font-weight:bold;font-size:18px;font-weight:500;&:hover{background:white;border-bottom-color:white;box-shadow:0 8px 16px -2px rgba(0,32,128,0.25);text-decoration:none;}',
        ]),
        tn = r.c.button.withConfig({
        ...
        In = { verticalAlign: -6, marginRight: 10 },
        an = P()({}, In, { color: '#ffe6b3', width: 20, height: 20 }),
        cn = P()({}, In, { color: '#333' }),
        ln = { width: 36, height: 36 },
        gn = (function(n) {
          function t() {
            for (
              var t, e = arguments.length, i = new Array(e), o = 0;
              ...
              return a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      ...
                      a.a.createElement(
                        ...
                        a.a.createElement(F.a, { style: cn }),
                        'View on GitHub',
                      ),
                    ),
                  ),
                  a.a.createElement(
                    ...
                    a.a.createElement(V.a, { style: ln }),
                  ),
                  a.a.createElement(
                    en,
                    { href: 'https://popper.js.org' },
                    a.a.createElement(E.a, { style: an }),
        ...
        rn = Object(r.c)('svg')(K(), on),
        dn = r.c.main.withConfig({
          displayName: 'Main',
          componentId: 'sc-7otpyo-0',
        })(['', '{margin-left:250px;}'], l.g.lg),
        pn = r.c.footer.withConfig({
          displayName: 'Footer',
      ...
      var Mn =
        ...
        yn = Object(r.a)(Nn(), Mn, l.g.sm, l.g.md, l.g.md, Mn, l.g.sm, l.g.md)
      var xn = function() {
          return a.a.createElement(
            a.a.Fragment,
            null,
          ...
          return (
            ...
            (e.render = function() {
              ...
              return a.a.createElement(
                ...
                a.a.createElement(sn.a, { pageContext: i }),
...
//# sourceMappingURL=1-83bd65c27e5eedf5760c.js.map
